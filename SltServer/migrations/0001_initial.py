# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-06-28 17:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DutMode', models.CharField(blank=True, choices=[(b'N', b'nosgmii'), (b'F', b'fullsgmii')], default=b'', max_length=255, null=True)),
